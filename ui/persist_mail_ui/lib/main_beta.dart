...
void main() async {
  ...
  AppLogger.info('App Starting - Beta Flavor');
  ...
  // Set flavor for beta
  AppConfig.currentFlavor = Flavor.BETA;
  AppLogger.info('App Configuration Set', {'flavor': 'BETA'});

  AppLogger.info('Launching PersistMail App (Beta)');
